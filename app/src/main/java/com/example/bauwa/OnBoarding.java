...
import com.example.bauwa.HelperClasses.SliderAdapter;
...
public class OnBoarding extends AppCompatActivity implements View.OnClickListener {
    ...
    private void addDots(int position){
        ...
        if (dots.length > 0){
            dots[position].setTextColor(getResources().getColor(R.color.colorPrimaryVariant));
        }
    }
